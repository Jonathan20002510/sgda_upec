...
<table id="DataTable" class="table table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('add.cargo.edit',$position->id)}}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit fa-1x ">
          </i>
        </a>
        

        <a href="{{route('add.cargo.delete',$position->id)}}" class="btn btn-danger btn-sm" title="Inactivar">
      ...
      @else
      <td>
        <a href="{{route('add.cargo.restore',$position->id)}}" class="btn btn-success btn-sm" title="Restaurar"><i class="fas fa-recycle fa-1x ">
          </i>
        </a>
