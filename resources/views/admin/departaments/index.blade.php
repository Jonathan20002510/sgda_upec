...
<table id="DataTable" class="table table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      @if ($departament->deleted_at!=null)
      <td>
        <a href="{{ route('restore.departament', ['id' => $departament->id]) }}" class="btn btn-success btn-sm" title="Restaurar"><i class="fas fa-recycle fa-1x ">
        </i>
      </a>
      </td>
      ...
      @else  
      <td>
        <a href="{{ route('edit.departament', ['id' => $departament->id]) }}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit fa-1x ">
          </i>
          
        </a>

        <a href="{{ route('delete.departament', ['id' => $departament->id]) }}" class="btn btn-danger btn-sm" title="Inactivar">
