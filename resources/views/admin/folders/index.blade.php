...
<div class="form-group">
  <label for="exampleSelect1" class="form-label mt-4">Carpeta Superior</label>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{route('carpetas.restore',$folder->id),'/restaurar'}}" class="btn btn-success btn-sm" title="Dar de baja">
          <i class="fas fa-recycle fa-1x"></i>
        </a>
      </td>
      @else
      <td>
        <a href="{{route('carpetas.edit',$folder->id)}}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit fa-1x ">
          </i>
        </a>

        <a href="{{route('carpetas.delete',$folder->id),'/eliminar'}}" class="btn btn-danger btn-sm" title="Dar de baja">
