...
<table id="DataTable" class="table table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('tipe.doc.edit', $type->id) }}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit fa-1x ">
          </i>
         
        </a>
        
        <a href="{{ route('tipe.doc.delete', $type->id) }}" class="btn btn-danger btn-sm" title="Inactivar">
      ...
      @else
      <td>
        <a href="{{ route('tipe.doc.restore', $type->id) }}" class="btn btn-success btn-sm" title="Restaurar"><i class="fas fa-recycle fa-1x ">
          </i>
        </a>
