...
<table id="DataTable" class="table table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('trato.honor.edit',$treatment->id)}}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-edit fa-1x ">
          </i>
        </a>

        <a href="{{route('trato.honor.delete',$treatment->id),'/eliminar'}}" class="btn btn-danger btn-sm" title="Inactivar">
      ...
      @else
      <td>
        <a href="{{route('trato.honor.restore',$treatment->id),'/restaurar'}}" class="btn btn-success btn-sm" title="Restaurar"><i class="fas fa-recycle fa-1x ">
          </i>
        </a>
