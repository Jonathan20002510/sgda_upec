...
@else
<div class="card-header">Documentos de Secretaria General</div>
@endif
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="{{ route('MostrarDocumentos', ['id' => $folder->id]) }}" class="btn btn-primary btn-sm" title="Editar"><i class="fas fa-folder-open fa-1x"> Abrir Carpeta</i>
        </a>
