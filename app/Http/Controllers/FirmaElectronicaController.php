...
class FirmaElectronicaController extends Controller
{
    ...
    public function FirmarDoc($id, Request $request){
        ...
        if(( $pdfAFirmar !==null )and ($request->hasFile("p12"))){
            ...
            $rutaGuardado="C:/xampp/htdocs/sgd_upec/public/pdf/";
                copy($filep12,$rutap12);
                $certificado=$rutaGuardado.$nombrep12;           
$horiz=260;$vert=210;
try{    $client = new Client([
        'headers' => [ 'Content-Type' => 'application/json; charset="utf-8"' ]    ]);
    $response = $client->post('http://10.100.100.139:8080/firmadocumental/APIREST/Firmarpdf',
        ['body' => json_encode(
    ...
    $client = new Client([
        ...
        $response = $client->post('http://10.100.100.139:8080/firmadocumental/APIREST/Validarpdf',
        ['body' => json_encode(
